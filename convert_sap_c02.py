#!/usr/bin/env python3
"""
SAP-C02 to SAA-C03 JSON Converter

This script converts SAP-C02 format JSON files to SAA-C03 format.
It reads all JSON files from SAP-C02 directory and merges them into a single SAA-C03 format file.
"""
...
def convert_sap_c02_question_to_saa_c03(question_data: Dict[str, Any], question_number: int) -> Dict[str, Any]:
    """
    Convert a single SAP-C02 question to SAA-C03 format
    """
...
def load_sap_c02_file(file_path: str) -> List[Dict[str, Any]]:
    """
    Load and parse a SAP-C02 JSON file
    """
    try:
...
def convert_all_sap_c02_files(input_dir: str, output_file: str):
    """
    Convert all SAP-C02 JSON files to SAA-C03 format
    """
    ...
    for file_path in json_files:
        ...
        questions = load_sap_c02_file(file_path)
        
        # Convert each question
        for question_data in questions:
            try:
                converted_question = convert_sap_c02_question_to_saa_c03(question_data, question_number)
...
def main():
    ...
    Main function
    """
    input_directory = "SAP-C02"
    output_file = "SAP-C02.json"
    ...
    print(f"Converting SAP-C02 files from '{input_directory}' to '{output_file}'")
    
    # Perform the conversion
    convert_all_sap_c02_files(input_directory, output_file)
